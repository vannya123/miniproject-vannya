            ...
            <td bgcolor="white" valign="top">
                <table border="0" width="100%" height="100%">
                    <tr>
                        ...
                        <form action="aksi_buku.php" method="POST" align="center">
                            <h1><b>Pendaftaran</b></h1>
                            <hr width="50%" align="center">
                            <p>Isilah seluruh kolom registrasi dengan sebenar-benarnya.</p>
                            <table width="50%" cellpadding="10" border="0" align="center" bgcolor="#3CB371">
                                <tr>
                                    <td width="30%">Kode Buku</td>
                                    <td width="10%">:</td>
                                    <td width="60%"><input name="kode_buku" type="text" maxlength="50" placeholder="Masukkan Kode"></td>
                                </tr>
                                <tr>
                                    <td>Judul Buku</td>
                                    <td>:</td>
                                    <td><input name="judul" type="text" maxlength="50" placeholder="Masukkan Judul"></td>
                                </tr>
                                <tr>
                                    <td>Pengarang</td>
                                    <td>:</td>
                                    <td><input name="pengarang" type="text" maxlength="50" placeholder="Masukkan Pengarang"></td>
                                </tr>
                                <tr>
                                    <td>Penerbit</td>
                                    <td>:</td>
                                    <td><input name="penerbit" type="text" maxlength="50" placeholder="Masukkan Penerbit"></td>
                                </tr>
                                <tr>
                                    <td>Tahun Terbit</td>
                                    <td>:</td>
                                    <td><input name="tahun_terbit" type="number" maxlength="20" placeholder="Masukkan Tahun"></td>
                                </tr>
                                <tr>
